...
VarChar::VarChar(ucs4_t ch) : m_ucs4ch(ch) {}

VarChar::VarChar(const VarChar &ch) : m_ucs4ch(ch.toUCS4()) {}
...
ucs4_t VarChar::toUCS4() const { return m_ucs4ch; }

bool VarChar::isEmoji(void) const { return Emoji::isEmoji(*this); }
