...
VarString::VarString(const std::string &text) : VarString(text.c_str()) {}

VarString::VarString(const std::wstring &text) : VarString(text.c_str()) {}

VarString::~VarString(void) {}

VarChar &VarString::operator[](int index) { return m_varchar[index]; }

VarChar VarString::operator[](int index) const { return m_varchar[index]; }

int VarString::length(void) const { return (int)m_varchar.size(); }
